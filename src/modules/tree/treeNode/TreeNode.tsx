...
import { useCreateNode } from '../../../shared/hooks/useCreateNode';
import { useDeleteNode } from '../../../shared/hooks/useDeleteNode';
import { useUpdateNode } from '../../../shared/hooks/useUpdateNode';
...
export const TreeNode = ({ node, setSelectedNode, selectedNode }: TreeNodeTypeProps) => {
      ...
      {showChildren && children && (
        <div style={{ marginLeft: '24px' }}>
          {children.map((child: TreeNodeType) => (
            <TreeNode key={child.id} node={child} setSelectedNode={setSelectedNode} selectedNode={selectedNode} />
          ))}
        </div>
      )}
      {addNodeModalIsOpen && (
