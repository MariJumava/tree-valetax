...
export const DeleteNodeModal = ({ isOpen, setModal, nodeName, onDeleteButtonClick, isLoading }: DeleteNodeModalPropsType) => {
  return (
      ...
      {isLoading ? (
        ...
        <div className={styles.form}>
          <div className={styles.title}>
            Do you want to delete <span className={styles.nodeName}>"{nodeName}"</span>
          </div>
