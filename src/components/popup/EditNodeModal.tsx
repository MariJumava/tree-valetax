  ...
  return (
    <Modal modal={isOpen} setModal={() => setModal(false)}>
      {isLoading ? (
        ...
        <form className={styles.form} onSubmit={onEditButtonClick}>
          <div className={styles.title}>Edit</div>
          <Input placeholder="New node name" value={inputValue} onChange={onChangeInputValue} id="new-node-name" fullWidth />
